                    ...
                    <div class="mb-4">
                        ...
                        <div class="card p-3 bg-light border-0">
                            ...
                            <div>
                                ...
                                <input type="url" id="image_url" name="image_url" class="form-control" placeholder="https://example.com/image.jpg" value="{{ old('image_url', filter_var($question->image_url, FILTER_VALIDATE_URL) ? $question->image_url : '') }}">
                            </div>
                        </div>
                    </div>
